...
class Pin():
    ...
    _assign_out = {"send_d0":3,"send_d1":4,"send_d2":17,
                  ...
                  "send_ch1":9,"stat_out1":6,"stat_out2":13,
                  "stat_out3":19,"stat_out4":26,"stat_out5":12,
                  "err_out":16}
    #入力ピン番号
    _assign_in = {"recv":2,"mode_changer1":11,"mode_changer2":5,
                 "stat_in1":18,"stat_in2":23,"stat_in3":24,
                 "stat_in4":8,"stat_in5":7,"detector":20}
    ...
    def set_ir_stat(self,status):
        _ir_pin=[[1,0,1,0,0],
                ...
                [0,1,1,0,0],
                [0,1,0,1,0]]
        self.digital_write("send_ch1",self._ir_pin[status][0])
        self.digital_write("send_ch2",self._ir_pin[status][1])
        self.digital_write("send_d0",self._ir_pin[status][2])
        self.digital_write("send_d1",self._ir_pin[status][3])
        self.digital_write("send_d2",self._ir_pin[status][4])
